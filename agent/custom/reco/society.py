    ...
    def analyze(
        ...
        if reco_detail and reco_detail.hit:
            ...
            for result in reco_detail.filtered_results:
                items_list.append({"box": result.box, "text": int(result.text.replace(",", ""))})
        ...
        reco_detail = context.run_recognition(
            ...
            argv.image,
            pipeline_override={"SocietyRequestChooseItem": {"recognition": "FeatureMatch", "template": "items/logic_yellow.png"}},
        )
